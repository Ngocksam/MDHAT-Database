...
CREATE TABLE `tblcomplaints` (
  ...
  `genre` varchar(255),
  `statut_matrimonial` varchar(255),
  `contact` varchar(255),
  `email` varchar(255),
  `adresse` varchar(255)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ADD COLUMN statut_matrimonial VARCHAR(255),
ADD COLUMN contact VARCHAR(255),
ADD COLUMN email VARCHAR(255),
ADD COLUMN adresse VARCHAR(255);

ALTER TABLE tblcomplaints
MODIFY lastUpdationDate TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;

INSERT INTO tblcomplaints (nom_complet, genre, statut_matrimonial, contact, email, adresse)
VALUES (:nom_complet, :genre, :statut_matrimonial, :contact, :email, :adresse)
